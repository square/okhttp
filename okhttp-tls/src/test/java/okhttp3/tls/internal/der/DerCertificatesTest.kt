...
internal class DerCertificatesTest {
  ...
  fun `decode simple certificate`() {
    ...
    val okHttpCertificate = CertificateAdapters.certificate.fromDer(certificateByteString)
            ...
            Certificate(
                tbsCertificate =
                    TbsCertificate(
                        ...
                        signature =
                            AlgorithmIdentifier(
                                algorithm = sha256WithRSAEncryption, parameters = null),
                        issuer =
                            listOf(
                                listOf(
                                    AttributeTypeAndValue(type = commonName, value = "cash.app"))),
                        validity = Validity(notBefore = 0L, notAfter = 1000L),
                        subject =
                            listOf(
                                listOf(
                                    AttributeTypeAndValue(type = commonName, value = "cash.app"))),
                        subjectPublicKeyInfo =
                            SubjectPublicKeyInfo(
                                ...
                                subjectPublicKey =
                                    BitString(byteString = publicKeyBytes, unusedBitsCount = 0)),
                        issuerUniqueID = null,
                        subjectUniqueID = null,
                        extensions = listOf()),
                signatureAlgorithm =
                    AlgorithmIdentifier(algorithm = sha256WithRSAEncryption, parameters = null),
                signatureValue = BitString(byteString = signatureBytes, unusedBitsCount = 0)))
  }
            ...
            Certificate(
                tbsCertificate =
                    TbsCertificate(
                        ...
                        issuer =
                            listOf(
                                listOf(AttributeTypeAndValue(type = countryName, value = "US")),
                                listOf(
                                    AttributeTypeAndValue(
                                        type = organizationName, value = "Entrust, Inc.")),
                                listOf(
                                    AttributeTypeAndValue(
                        ...
                        validity = Validity(notBefore = 1411406097000L, notAfter = 1727055113000L),
                        subject =
                            listOf(
                                listOf(AttributeTypeAndValue(type = countryName, value = "US")),
                                listOf(
                        ...
                        extensions =
                            listOf(
                                Extension(
                                    id = keyUsage, critical = true, value = "03020106".decodeHex()),
                                Extension(
                                    id = basicConstraints,
                                    critical = true,
                                    value = BasicConstraints(ca = true, maxIntermediateCas = 1L)),
                                Extension(
                                ...
                                Extension(
                                    ...
                                    critical = false,
                                    value =
                                        "04146a72267ad01eef7de73b6951d46c8d9f901266ab".decodeHex()),
                                Extension(
                                    id = authorityKeyIdentifier,
                                    critical = false,
                                    value =
                                        "301680146890e467a4a65380c78666a4f1f74b43fb84bd6d".decodeHex()))),
                signatureAlgorithm =
                    AlgorithmIdentifier(algorithm = sha256WithRSAEncryption, parameters = null),
                signatureValue = BitString(byteString = signatureBytes, unusedBitsCount = 0)))
  }
            ...
            Certificate(
                tbsCertificate =
                    TbsCertificate(
                        ...
                        validity = Validity(notBefore = 1586784349000L, notAfter = 1618235749000L),
                        subject =
                            listOf(
                                listOf(AttributeTypeAndValue(type = countryName, value = "US")),
                                listOf(
                                    AttributeTypeAndValue(
                                        type = stateOrProvinceName, value = "California")),
                                listOf(
                                    AttributeTypeAndValue(
                                        type = localityName, value = "San Francisco")),
                                listOf(AttributeTypeAndValue(type = country, value = "US")),
                                listOf(
                                    AttributeTypeAndValue(
                                        type = stateOrProvince, value = "Delaware")),
                                listOf(
                                    AttributeTypeAndValue(
                                        type = organizationName, value = "Square, Inc.")),
                                listOf(
                                    AttributeTypeAndValue(
                                        type = businessCategory, value = "Private Organization")),
                                listOf(
                                    AttributeTypeAndValue(type = serialNumber, value = "4699855")),
                                listOf(
                                    AttributeTypeAndValue(type = commonName, value = "cash.app"))),
                        subjectPublicKeyInfo =
                            SubjectPublicKeyInfo(
                        ...
                        extensions =
                            listOf(
                                Extension(
                                    ...
                                    value =
                                        listOf(
                                            ...
                                            CertificateAdapters.generalNameDnsName to
                                                "www.cash.app")),
                                Extension(
                                    ...
                                    value =
                                        ("0482016b01690077005614069a2fd7c2ecd3f5e1bd44b23ec74676b9bc9" +
                                            ...
                                            .decodeHex()),
                                Extension(
                                    id = keyUsage, critical = true, value = "030205a0".decodeHex()),
                                Extension(
                                    id = extendedKeyUsage,
                                    critical = false,
                                    value =
                                        "301406082b0601050507030106082b06010505070302".decodeHex()),
                                Extension(
                                    id = authorityInfoAccess,
                                    critical = false,
                                    value =
                                ...
                                Extension(
                                    ...
                                    critical = false,
                                    value =
                                        ("30168014c3f7d0b52a30adaf0d9121703954ddbc8970c73a")
                                            .decodeHex()),
                                Extension(
                                    id = subjectKeyIdentifier,
                                    critical = false,
                                    value =
                                        "041475fd24c2df592599e32f3373e18c0450dd1b87b6".decodeHex()),
                                Extension(
                                    id = basicConstraints,
                                    critical = false,
                                    value =
                                        BasicConstraints(ca = false, maxIntermediateCas = null)))),
                signatureAlgorithm =
                    AlgorithmIdentifier(algorithm = sha256WithRSAEncryption, parameters = null),
                signatureValue = BitString(byteString = signatureBytes, unusedBitsCount = 0)))
  }
  ...
  fun `certificate attributes`() {
    ...
    assertThat(okHttpCertificate.basicConstraints)
        .isEqualTo(
            Extension(id = basicConstraints, critical = true, value = BasicConstraints(true, 3)))
    ...
    assertThat(okHttpCertificate.subjectAlternativeNames)
        .isEqualTo(
            Extension(
                id = subjectAlternativeName,
                critical = true,
  ...
  fun `public key`() {
    ...
    val x509PublicKey = encodeKey(algorithm = rsaEncryption, publicKeyBytes = publicKeyBytes)
    ...
    val certificate = HeldCertificate.Builder().keyPair(publicKey, privateKey).build()
  ...
  fun `RSA issuer and signature`() {
    val root = HeldCertificate.Builder().certificateAuthority(0).rsa2048().build()
  ...
  fun `EC issuer and signature`() {
    val root = HeldCertificate.Builder().certificateAuthority(0).ecdsa256().build()
    val certificate = HeldCertificate.Builder().signedBy(root).ecdsa256().build()
  ...
  fun `unsupported general name tag`() {
    ...
    val decoded = CertificateAdapters.certificate.fromDer(certificateByteString)
    assertThat(decoded.subjectAlternativeNames)
        .isEqualTo(
            Extension(
                id = subjectAlternativeName,
                critical = false,
