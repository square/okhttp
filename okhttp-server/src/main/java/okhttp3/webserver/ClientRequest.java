...
/** An HTTP request that came into the web server. */
public final class ClientRequest {
  ...
  public ClientRequest(String requestLine, Headers headers, List<Integer> chunkSizes, long bodySize,
      Buffer body, int sequenceNumber, Socket socket) {
