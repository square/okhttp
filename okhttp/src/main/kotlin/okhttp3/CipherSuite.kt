...
private constructor(
  ...
  companion object {
    ...
    // @JvmField val TLS_DH_DSS_WITH_3DES_EDE_CBC_SHA = init("TLS_DH_DSS_WITH_3DES_EDE_CBC_SHA",
    // 0x000d)
    // @JvmField val TLS_DH_RSA_EXPORT_WITH_DES40_CBC_SHA =
    // init("SSL_DH_RSA_EXPORT_WITH_DES40_CBC_SHA", 0x000e)
    // @JvmField val TLS_DH_RSA_WITH_DES_CBC_SHA = init("TLS_DH_RSA_WITH_DES_CBC_SHA", 0x000f)
    // @JvmField val TLS_DH_RSA_WITH_3DES_EDE_CBC_SHA = init("TLS_DH_RSA_WITH_3DES_EDE_CBC_SHA",
    // 0x0010)
    @JvmField
    ...
    // 0x0030)
    // @JvmField val TLS_DH_RSA_WITH_AES_128_CBC_SHA = init("TLS_DH_RSA_WITH_AES_128_CBC_SHA",
    // 0x0031)
    @JvmField
    ...
    // 0x0036)
    // @JvmField val TLS_DH_RSA_WITH_AES_256_CBC_SHA = init("TLS_DH_RSA_WITH_AES_256_CBC_SHA",
    // 0x0037)
    @JvmField
    ...
    // 0x003e)
    // @JvmField val TLS_DH_RSA_WITH_AES_128_CBC_SHA256 = init("TLS_DH_RSA_WITH_AES_128_CBC_SHA256",
    // 0x003f)
    @JvmField
    ...
    // @JvmField val TLS_DH_DSS_WITH_CAMELLIA_128_CBC_SHA =
    // init("TLS_DH_DSS_WITH_CAMELLIA_128_CBC_SHA", 0x0042)
    // @JvmField val TLS_DH_RSA_WITH_CAMELLIA_128_CBC_SHA =
    // init("TLS_DH_RSA_WITH_CAMELLIA_128_CBC_SHA", 0x0043)
    @JvmField
    val TLS_DHE_DSS_WITH_CAMELLIA_128_CBC_SHA =
        init("TLS_DHE_DSS_WITH_CAMELLIA_128_CBC_SHA", 0x0044)

    @JvmField
    val TLS_DHE_RSA_WITH_CAMELLIA_128_CBC_SHA =
        init("TLS_DHE_RSA_WITH_CAMELLIA_128_CBC_SHA", 0x0045)

    // @JvmField val TLS_DH_anon_WITH_CAMELLIA_128_CBC_SHA =
    // init("TLS_DH_anon_WITH_CAMELLIA_128_CBC_SHA", 0x0046)
    @JvmField
    val TLS_DHE_RSA_WITH_AES_128_CBC_SHA256 = init("TLS_DHE_RSA_WITH_AES_128_CBC_SHA256", 0x0067)

    // @JvmField val TLS_DH_DSS_WITH_AES_256_CBC_SHA256 = init("TLS_DH_DSS_WITH_AES_256_CBC_SHA256",
    // 0x0068)
    // @JvmField val TLS_DH_RSA_WITH_AES_256_CBC_SHA256 = init("TLS_DH_RSA_WITH_AES_256_CBC_SHA256",
    // 0x0069)
    @JvmField
    ...
    // @JvmField val TLS_DH_DSS_WITH_CAMELLIA_256_CBC_SHA =
    // init("TLS_DH_DSS_WITH_CAMELLIA_256_CBC_SHA", 0x0085)
    // @JvmField val TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA =
    // init("TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA", 0x0086)
    @JvmField
    val TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA =
    ...
    // 0x008f)
    // @JvmField val TLS_DHE_PSK_WITH_AES_128_CBC_SHA = init("TLS_DHE_PSK_WITH_AES_128_CBC_SHA",
    // 0x0090)
    // @JvmField val TLS_DHE_PSK_WITH_AES_256_CBC_SHA = init("TLS_DHE_PSK_WITH_AES_256_CBC_SHA",
    // 0x0091)
    // @JvmField val TLS_RSA_PSK_WITH_RC4_128_SHA = init("TLS_RSA_PSK_WITH_RC4_128_SHA", 0x0092)
    // @JvmField val TLS_RSA_PSK_WITH_3DES_EDE_CBC_SHA = init("TLS_RSA_PSK_WITH_3DES_EDE_CBC_SHA",
    // 0x0093)
    // @JvmField val TLS_RSA_PSK_WITH_AES_128_CBC_SHA = init("TLS_RSA_PSK_WITH_AES_128_CBC_SHA",
    // 0x0094)
    ...
    // @JvmField val TLS_DH_RSA_WITH_AES_128_GCM_SHA256 = init("TLS_DH_RSA_WITH_AES_128_GCM_SHA256",
    // 0x00a0)
    // @JvmField val TLS_DH_RSA_WITH_AES_256_GCM_SHA384 = init("TLS_DH_RSA_WITH_AES_256_GCM_SHA384",
    // 0x00a1)
    @JvmField
    ...
    // @JvmField val TLS_DH_DSS_WITH_AES_128_GCM_SHA256 = init("TLS_DH_DSS_WITH_AES_128_GCM_SHA256",
    // 0x00a4)
    // @JvmField val TLS_DH_DSS_WITH_AES_256_GCM_SHA384 = init("TLS_DH_DSS_WITH_AES_256_GCM_SHA384",
    // 0x00a5)
    @JvmField
    ...
    // @JvmField val TLS_PSK_WITH_AES_128_GCM_SHA256 = init("TLS_PSK_WITH_AES_128_GCM_SHA256",
    // 0x00a8)
    // @JvmField val TLS_PSK_WITH_AES_256_GCM_SHA384 = init("TLS_PSK_WITH_AES_256_GCM_SHA384",
    // 0x00a9)
    // @JvmField val TLS_DHE_PSK_WITH_AES_128_GCM_SHA256 =
    // init("TLS_DHE_PSK_WITH_AES_128_GCM_SHA256", 0x00aa)
    // @JvmField val TLS_DHE_PSK_WITH_AES_256_GCM_SHA384 =
    // init("TLS_DHE_PSK_WITH_AES_256_GCM_SHA384", 0x00ab)
    // @JvmField val TLS_RSA_PSK_WITH_AES_128_GCM_SHA256 =
    // init("TLS_RSA_PSK_WITH_AES_128_GCM_SHA256", 0x00ac)
    // @JvmField val TLS_RSA_PSK_WITH_AES_256_GCM_SHA384 =
    // init("TLS_RSA_PSK_WITH_AES_256_GCM_SHA384", 0x00ad)
    // @JvmField val TLS_PSK_WITH_AES_128_CBC_SHA256 = init("TLS_PSK_WITH_AES_128_CBC_SHA256",
    // 0x00ae)
    // @JvmField val TLS_PSK_WITH_AES_256_CBC_SHA384 = init("TLS_PSK_WITH_AES_256_CBC_SHA384",
    // 0x00af)
    ...
    // @JvmField val TLS_DHE_PSK_WITH_AES_128_CBC_SHA256 =
    // init("TLS_DHE_PSK_WITH_AES_128_CBC_SHA256", 0x00b2)
    // @JvmField val TLS_DHE_PSK_WITH_AES_256_CBC_SHA384 =
    // init("TLS_DHE_PSK_WITH_AES_256_CBC_SHA384", 0x00b3)
    ...
    // @JvmField val TLS_RSA_PSK_WITH_AES_128_CBC_SHA256 =
    // init("TLS_RSA_PSK_WITH_AES_128_CBC_SHA256", 0x00b6)
    // @JvmField val TLS_RSA_PSK_WITH_AES_256_CBC_SHA384 =
    // init("TLS_RSA_PSK_WITH_AES_256_CBC_SHA384", 0x00b7)
    ...
    // @JvmField val TLS_RSA_WITH_CAMELLIA_128_CBC_SHA256 =
    // init("TLS_RSA_WITH_CAMELLIA_128_CBC_SHA256", 0x00ba)
    // @JvmField val TLS_DH_DSS_WITH_CAMELLIA_128_CBC_SHA256 =
    // init("TLS_DH_DSS_WITH_CAMELLIA_128_CBC_SHA256", 0x00bb)
    // @JvmField val TLS_DH_RSA_WITH_CAMELLIA_128_CBC_SHA256 =
    // init("TLS_DH_RSA_WITH_CAMELLIA_128_CBC_SHA256", 0x00bc)
    // @JvmField val TLS_DHE_DSS_WITH_CAMELLIA_128_CBC_SHA256 =
    // init("TLS_DHE_DSS_WITH_CAMELLIA_128_CBC_SHA256", 0x00bd)
    // @JvmField val TLS_DHE_RSA_WITH_CAMELLIA_128_CBC_SHA256 =
    // init("TLS_DHE_RSA_WITH_CAMELLIA_128_CBC_SHA256", 0x00be)
    // @JvmField val TLS_DH_anon_WITH_CAMELLIA_128_CBC_SHA256 =
    // init("TLS_DH_anon_WITH_CAMELLIA_128_CBC_SHA256", 0x00bf)
    // @JvmField val TLS_RSA_WITH_CAMELLIA_256_CBC_SHA256 =
    // init("TLS_RSA_WITH_CAMELLIA_256_CBC_SHA256", 0x00c0)
    // @JvmField val TLS_DH_DSS_WITH_CAMELLIA_256_CBC_SHA256 =
    // init("TLS_DH_DSS_WITH_CAMELLIA_256_CBC_SHA256", 0x00c1)
    // @JvmField val TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA256 =
    // init("TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA256", 0x00c2)
    // @JvmField val TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA256 =
    // init("TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA256", 0x00c3)
    // @JvmField val TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA256 =
    // init("TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA256", 0x00c4)
    // @JvmField val TLS_DH_anon_WITH_CAMELLIA_256_CBC_SHA256 =
    ...
    // @JvmField val TLS_SRP_SHA_WITH_3DES_EDE_CBC_SHA = init("TLS_SRP_SHA_WITH_3DES_EDE_CBC_SHA",
    // 0xc01a)
    // @JvmField val TLS_SRP_SHA_RSA_WITH_3DES_EDE_CBC_SHA =
    // init("TLS_SRP_SHA_RSA_WITH_3DES_EDE_CBC_SHA", 0xc01b)
    // @JvmField val TLS_SRP_SHA_DSS_WITH_3DES_EDE_CBC_SHA =
    // init("TLS_SRP_SHA_DSS_WITH_3DES_EDE_CBC_SHA", 0xc01c)
    // @JvmField val TLS_SRP_SHA_WITH_AES_128_CBC_SHA = init("TLS_SRP_SHA_WITH_AES_128_CBC_SHA",
    // 0xc01d)
    // @JvmField val TLS_SRP_SHA_RSA_WITH_AES_128_CBC_SHA =
    // init("TLS_SRP_SHA_RSA_WITH_AES_128_CBC_SHA", 0xc01e)
    // @JvmField val TLS_SRP_SHA_DSS_WITH_AES_128_CBC_SHA =
    // init("TLS_SRP_SHA_DSS_WITH_AES_128_CBC_SHA", 0xc01f)
    // @JvmField val TLS_SRP_SHA_WITH_AES_256_CBC_SHA = init("TLS_SRP_SHA_WITH_AES_256_CBC_SHA",
    // 0xc020)
    // @JvmField val TLS_SRP_SHA_RSA_WITH_AES_256_CBC_SHA =
    // init("TLS_SRP_SHA_RSA_WITH_AES_256_CBC_SHA", 0xc021)
    // @JvmField val TLS_SRP_SHA_DSS_WITH_AES_256_CBC_SHA =
    // init("TLS_SRP_SHA_DSS_WITH_AES_256_CBC_SHA", 0xc022)
    @JvmField
    ...
    @JvmField
    val TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA256 =
        init("TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA256", 0xc025)

    @JvmField
    val TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA384 =
    ...
    @JvmField
    val TLS_ECDH_ECDSA_WITH_AES_128_GCM_SHA256 =
        init("TLS_ECDH_ECDSA_WITH_AES_128_GCM_SHA256", 0xc02d)

    @JvmField
    val TLS_ECDH_ECDSA_WITH_AES_256_GCM_SHA384 =
    ...
    // @JvmField val TLS_ECDHE_PSK_WITH_3DES_EDE_CBC_SHA =
    // init("TLS_ECDHE_PSK_WITH_3DES_EDE_CBC_SHA", 0xc034)
    @JvmField
    ...
    // @JvmField val TLS_ECDHE_PSK_WITH_AES_128_CBC_SHA256 =
    // init("TLS_ECDHE_PSK_WITH_AES_128_CBC_SHA256", 0xc037)
    // @JvmField val TLS_ECDHE_PSK_WITH_AES_256_CBC_SHA384 =
    // init("TLS_ECDHE_PSK_WITH_AES_256_CBC_SHA384", 0xc038)
    ...
    // @JvmField val TLS_RSA_WITH_ARIA_128_CBC_SHA256 = init("TLS_RSA_WITH_ARIA_128_CBC_SHA256",
    // 0xc03c)
    // @JvmField val TLS_RSA_WITH_ARIA_256_CBC_SHA384 = init("TLS_RSA_WITH_ARIA_256_CBC_SHA384",
    // 0xc03d)
    // @JvmField val TLS_DH_DSS_WITH_ARIA_128_CBC_SHA256 =
    // init("TLS_DH_DSS_WITH_ARIA_128_CBC_SHA256", 0xc03e)
    // @JvmField val TLS_DH_DSS_WITH_ARIA_256_CBC_SHA384 =
    // init("TLS_DH_DSS_WITH_ARIA_256_CBC_SHA384", 0xc03f)
    // @JvmField val TLS_DH_RSA_WITH_ARIA_128_CBC_SHA256 =
    // init("TLS_DH_RSA_WITH_ARIA_128_CBC_SHA256", 0xc040)
    // @JvmField val TLS_DH_RSA_WITH_ARIA_256_CBC_SHA384 =
    // init("TLS_DH_RSA_WITH_ARIA_256_CBC_SHA384", 0xc041)
    // @JvmField val TLS_DHE_DSS_WITH_ARIA_128_CBC_SHA256 =
    // init("TLS_DHE_DSS_WITH_ARIA_128_CBC_SHA256", 0xc042)
    // @JvmField val TLS_DHE_DSS_WITH_ARIA_256_CBC_SHA384 =
    // init("TLS_DHE_DSS_WITH_ARIA_256_CBC_SHA384", 0xc043)
    // @JvmField val TLS_DHE_RSA_WITH_ARIA_128_CBC_SHA256 =
    // init("TLS_DHE_RSA_WITH_ARIA_128_CBC_SHA256", 0xc044)
    // @JvmField val TLS_DHE_RSA_WITH_ARIA_256_CBC_SHA384 =
    // init("TLS_DHE_RSA_WITH_ARIA_256_CBC_SHA384", 0xc045)
    // @JvmField val TLS_DH_anon_WITH_ARIA_128_CBC_SHA256 =
    // init("TLS_DH_anon_WITH_ARIA_128_CBC_SHA256", 0xc046)
    // @JvmField val TLS_DH_anon_WITH_ARIA_256_CBC_SHA384 =
    // init("TLS_DH_anon_WITH_ARIA_256_CBC_SHA384", 0xc047)
    // @JvmField val TLS_ECDHE_ECDSA_WITH_ARIA_128_CBC_SHA256 =
    // init("TLS_ECDHE_ECDSA_WITH_ARIA_128_CBC_SHA256", 0xc048)
    // @JvmField val TLS_ECDHE_ECDSA_WITH_ARIA_256_CBC_SHA384 =
    // init("TLS_ECDHE_ECDSA_WITH_ARIA_256_CBC_SHA384", 0xc049)
    // @JvmField val TLS_ECDH_ECDSA_WITH_ARIA_128_CBC_SHA256 =
    // init("TLS_ECDH_ECDSA_WITH_ARIA_128_CBC_SHA256", 0xc04a)
    // @JvmField val TLS_ECDH_ECDSA_WITH_ARIA_256_CBC_SHA384 =
    // init("TLS_ECDH_ECDSA_WITH_ARIA_256_CBC_SHA384", 0xc04b)
    // @JvmField val TLS_ECDHE_RSA_WITH_ARIA_128_CBC_SHA256 =
    // init("TLS_ECDHE_RSA_WITH_ARIA_128_CBC_SHA256", 0xc04c)
    // @JvmField val TLS_ECDHE_RSA_WITH_ARIA_256_CBC_SHA384 =
    // init("TLS_ECDHE_RSA_WITH_ARIA_256_CBC_SHA384", 0xc04d)
    // @JvmField val TLS_ECDH_RSA_WITH_ARIA_128_CBC_SHA256 =
    // init("TLS_ECDH_RSA_WITH_ARIA_128_CBC_SHA256", 0xc04e)
    // @JvmField val TLS_ECDH_RSA_WITH_ARIA_256_CBC_SHA384 =
    // init("TLS_ECDH_RSA_WITH_ARIA_256_CBC_SHA384", 0xc04f)
    // @JvmField val TLS_RSA_WITH_ARIA_128_GCM_SHA256 = init("TLS_RSA_WITH_ARIA_128_GCM_SHA256",
    // 0xc050)
    // @JvmField val TLS_RSA_WITH_ARIA_256_GCM_SHA384 = init("TLS_RSA_WITH_ARIA_256_GCM_SHA384",
    // 0xc051)
    // @JvmField val TLS_DHE_RSA_WITH_ARIA_128_GCM_SHA256 =
    // init("TLS_DHE_RSA_WITH_ARIA_128_GCM_SHA256", 0xc052)
    // @JvmField val TLS_DHE_RSA_WITH_ARIA_256_GCM_SHA384 =
    // init("TLS_DHE_RSA_WITH_ARIA_256_GCM_SHA384", 0xc053)
    // @JvmField val TLS_DH_RSA_WITH_ARIA_128_GCM_SHA256 =
    // init("TLS_DH_RSA_WITH_ARIA_128_GCM_SHA256", 0xc054)
    // @JvmField val TLS_DH_RSA_WITH_ARIA_256_GCM_SHA384 =
    // init("TLS_DH_RSA_WITH_ARIA_256_GCM_SHA384", 0xc055)
    // @JvmField val TLS_DHE_DSS_WITH_ARIA_128_GCM_SHA256 =
    // init("TLS_DHE_DSS_WITH_ARIA_128_GCM_SHA256", 0xc056)
    // @JvmField val TLS_DHE_DSS_WITH_ARIA_256_GCM_SHA384 =
    // init("TLS_DHE_DSS_WITH_ARIA_256_GCM_SHA384", 0xc057)
    // @JvmField val TLS_DH_DSS_WITH_ARIA_128_GCM_SHA256 =
    // init("TLS_DH_DSS_WITH_ARIA_128_GCM_SHA256", 0xc058)
    // @JvmField val TLS_DH_DSS_WITH_ARIA_256_GCM_SHA384 =
    // init("TLS_DH_DSS_WITH_ARIA_256_GCM_SHA384", 0xc059)
    // @JvmField val TLS_DH_anon_WITH_ARIA_128_GCM_SHA256 =
    // init("TLS_DH_anon_WITH_ARIA_128_GCM_SHA256", 0xc05a)
    // @JvmField val TLS_DH_anon_WITH_ARIA_256_GCM_SHA384 =
    // init("TLS_DH_anon_WITH_ARIA_256_GCM_SHA384", 0xc05b)
    // @JvmField val TLS_ECDHE_ECDSA_WITH_ARIA_128_GCM_SHA256 =
    // init("TLS_ECDHE_ECDSA_WITH_ARIA_128_GCM_SHA256", 0xc05c)
    // @JvmField val TLS_ECDHE_ECDSA_WITH_ARIA_256_GCM_SHA384 =
    // init("TLS_ECDHE_ECDSA_WITH_ARIA_256_GCM_SHA384", 0xc05d)
    // @JvmField val TLS_ECDH_ECDSA_WITH_ARIA_128_GCM_SHA256 =
    // init("TLS_ECDH_ECDSA_WITH_ARIA_128_GCM_SHA256", 0xc05e)
    // @JvmField val TLS_ECDH_ECDSA_WITH_ARIA_256_GCM_SHA384 =
    // init("TLS_ECDH_ECDSA_WITH_ARIA_256_GCM_SHA384", 0xc05f)
    // @JvmField val TLS_ECDHE_RSA_WITH_ARIA_128_GCM_SHA256 =
    // init("TLS_ECDHE_RSA_WITH_ARIA_128_GCM_SHA256", 0xc060)
    // @JvmField val TLS_ECDHE_RSA_WITH_ARIA_256_GCM_SHA384 =
    // init("TLS_ECDHE_RSA_WITH_ARIA_256_GCM_SHA384", 0xc061)
    // @JvmField val TLS_ECDH_RSA_WITH_ARIA_128_GCM_SHA256 =
    // init("TLS_ECDH_RSA_WITH_ARIA_128_GCM_SHA256", 0xc062)
    // @JvmField val TLS_ECDH_RSA_WITH_ARIA_256_GCM_SHA384 =
    // init("TLS_ECDH_RSA_WITH_ARIA_256_GCM_SHA384", 0xc063)
    // @JvmField val TLS_PSK_WITH_ARIA_128_CBC_SHA256 = init("TLS_PSK_WITH_ARIA_128_CBC_SHA256",
    // 0xc064)
    // @JvmField val TLS_PSK_WITH_ARIA_256_CBC_SHA384 = init("TLS_PSK_WITH_ARIA_256_CBC_SHA384",
    // 0xc065)
    // @JvmField val TLS_DHE_PSK_WITH_ARIA_128_CBC_SHA256 =
    // init("TLS_DHE_PSK_WITH_ARIA_128_CBC_SHA256", 0xc066)
    // @JvmField val TLS_DHE_PSK_WITH_ARIA_256_CBC_SHA384 =
    // init("TLS_DHE_PSK_WITH_ARIA_256_CBC_SHA384", 0xc067)
    // @JvmField val TLS_RSA_PSK_WITH_ARIA_128_CBC_SHA256 =
    // init("TLS_RSA_PSK_WITH_ARIA_128_CBC_SHA256", 0xc068)
    // @JvmField val TLS_RSA_PSK_WITH_ARIA_256_CBC_SHA384 =
    // init("TLS_RSA_PSK_WITH_ARIA_256_CBC_SHA384", 0xc069)
    // @JvmField val TLS_PSK_WITH_ARIA_128_GCM_SHA256 = init("TLS_PSK_WITH_ARIA_128_GCM_SHA256",
    // 0xc06a)
    // @JvmField val TLS_PSK_WITH_ARIA_256_GCM_SHA384 = init("TLS_PSK_WITH_ARIA_256_GCM_SHA384",
    // 0xc06b)
    // @JvmField val TLS_DHE_PSK_WITH_ARIA_128_GCM_SHA256 =
    // init("TLS_DHE_PSK_WITH_ARIA_128_GCM_SHA256", 0xc06c)
    // @JvmField val TLS_DHE_PSK_WITH_ARIA_256_GCM_SHA384 =
    // init("TLS_DHE_PSK_WITH_ARIA_256_GCM_SHA384", 0xc06d)
    // @JvmField val TLS_RSA_PSK_WITH_ARIA_128_GCM_SHA256 =
    // init("TLS_RSA_PSK_WITH_ARIA_128_GCM_SHA256", 0xc06e)
    // @JvmField val TLS_RSA_PSK_WITH_ARIA_256_GCM_SHA384 =
    // init("TLS_RSA_PSK_WITH_ARIA_256_GCM_SHA384", 0xc06f)
    // @JvmField val TLS_ECDHE_PSK_WITH_ARIA_128_CBC_SHA256 =
    // init("TLS_ECDHE_PSK_WITH_ARIA_128_CBC_SHA256", 0xc070)
    // @JvmField val TLS_ECDHE_PSK_WITH_ARIA_256_CBC_SHA384 =
    // init("TLS_ECDHE_PSK_WITH_ARIA_256_CBC_SHA384", 0xc071)
    // @JvmField val TLS_ECDHE_ECDSA_WITH_CAMELLIA_128_CBC_SHA256 =
    // init("TLS_ECDHE_ECDSA_WITH_CAMELLIA_128_CBC_SHA256", 0xc072)
    // @JvmField val TLS_ECDHE_ECDSA_WITH_CAMELLIA_256_CBC_SHA384 =
    // init("TLS_ECDHE_ECDSA_WITH_CAMELLIA_256_CBC_SHA384", 0xc073)
    // @JvmField val TLS_ECDH_ECDSA_WITH_CAMELLIA_128_CBC_SHA256 =
    // init("TLS_ECDH_ECDSA_WITH_CAMELLIA_128_CBC_SHA256", 0xc074)
    // @JvmField val TLS_ECDH_ECDSA_WITH_CAMELLIA_256_CBC_SHA384 =
    // init("TLS_ECDH_ECDSA_WITH_CAMELLIA_256_CBC_SHA384", 0xc075)
    // @JvmField val TLS_ECDHE_RSA_WITH_CAMELLIA_128_CBC_SHA256 =
    // init("TLS_ECDHE_RSA_WITH_CAMELLIA_128_CBC_SHA256", 0xc076)
    // @JvmField val TLS_ECDHE_RSA_WITH_CAMELLIA_256_CBC_SHA384 =
    // init("TLS_ECDHE_RSA_WITH_CAMELLIA_256_CBC_SHA384", 0xc077)
    // @JvmField val TLS_ECDH_RSA_WITH_CAMELLIA_128_CBC_SHA256 =
    // init("TLS_ECDH_RSA_WITH_CAMELLIA_128_CBC_SHA256", 0xc078)
    // @JvmField val TLS_ECDH_RSA_WITH_CAMELLIA_256_CBC_SHA384 =
    // init("TLS_ECDH_RSA_WITH_CAMELLIA_256_CBC_SHA384", 0xc079)
    // @JvmField val TLS_RSA_WITH_CAMELLIA_128_GCM_SHA256 =
    // init("TLS_RSA_WITH_CAMELLIA_128_GCM_SHA256", 0xc07a)
    // @JvmField val TLS_RSA_WITH_CAMELLIA_256_GCM_SHA384 =
    // init("TLS_RSA_WITH_CAMELLIA_256_GCM_SHA384", 0xc07b)
    // @JvmField val TLS_DHE_RSA_WITH_CAMELLIA_128_GCM_SHA256 =
    // init("TLS_DHE_RSA_WITH_CAMELLIA_128_GCM_SHA256", 0xc07c)
    // @JvmField val TLS_DHE_RSA_WITH_CAMELLIA_256_GCM_SHA384 =
    // init("TLS_DHE_RSA_WITH_CAMELLIA_256_GCM_SHA384", 0xc07d)
    // @JvmField val TLS_DH_RSA_WITH_CAMELLIA_128_GCM_SHA256 =
    // init("TLS_DH_RSA_WITH_CAMELLIA_128_GCM_SHA256", 0xc07e)
    // @JvmField val TLS_DH_RSA_WITH_CAMELLIA_256_GCM_SHA384 =
    // init("TLS_DH_RSA_WITH_CAMELLIA_256_GCM_SHA384", 0xc07f)
    // @JvmField val TLS_DHE_DSS_WITH_CAMELLIA_128_GCM_SHA256 =
    // init("TLS_DHE_DSS_WITH_CAMELLIA_128_GCM_SHA256", 0xc080)
    // @JvmField val TLS_DHE_DSS_WITH_CAMELLIA_256_GCM_SHA384 =
    // init("TLS_DHE_DSS_WITH_CAMELLIA_256_GCM_SHA384", 0xc081)
    // @JvmField val TLS_DH_DSS_WITH_CAMELLIA_128_GCM_SHA256 =
    // init("TLS_DH_DSS_WITH_CAMELLIA_128_GCM_SHA256", 0xc082)
    // @JvmField val TLS_DH_DSS_WITH_CAMELLIA_256_GCM_SHA384 =
    // init("TLS_DH_DSS_WITH_CAMELLIA_256_GCM_SHA384", 0xc083)
    // @JvmField val TLS_DH_anon_WITH_CAMELLIA_128_GCM_SHA256 =
    // init("TLS_DH_anon_WITH_CAMELLIA_128_GCM_SHA256", 0xc084)
    // @JvmField val TLS_DH_anon_WITH_CAMELLIA_256_GCM_SHA384 =
    // init("TLS_DH_anon_WITH_CAMELLIA_256_GCM_SHA384", 0xc085)
    // @JvmField val TLS_ECDHE_ECDSA_WITH_CAMELLIA_128_GCM_SHA256 =
    // init("TLS_ECDHE_ECDSA_WITH_CAMELLIA_128_GCM_SHA256", 0xc086)
    // @JvmField val TLS_ECDHE_ECDSA_WITH_CAMELLIA_256_GCM_SHA384 =
    // init("TLS_ECDHE_ECDSA_WITH_CAMELLIA_256_GCM_SHA384", 0xc087)
    // @JvmField val TLS_ECDH_ECDSA_WITH_CAMELLIA_128_GCM_SHA256 =
    // init("TLS_ECDH_ECDSA_WITH_CAMELLIA_128_GCM_SHA256", 0xc088)
    // @JvmField val TLS_ECDH_ECDSA_WITH_CAMELLIA_256_GCM_SHA384 =
    // init("TLS_ECDH_ECDSA_WITH_CAMELLIA_256_GCM_SHA384", 0xc089)
    // @JvmField val TLS_ECDHE_RSA_WITH_CAMELLIA_128_GCM_SHA256 =
    // init("TLS_ECDHE_RSA_WITH_CAMELLIA_128_GCM_SHA256", 0xc08a)
    // @JvmField val TLS_ECDHE_RSA_WITH_CAMELLIA_256_GCM_SHA384 =
    // init("TLS_ECDHE_RSA_WITH_CAMELLIA_256_GCM_SHA384", 0xc08b)
    // @JvmField val TLS_ECDH_RSA_WITH_CAMELLIA_128_GCM_SHA256 =
    // init("TLS_ECDH_RSA_WITH_CAMELLIA_128_GCM_SHA256", 0xc08c)
    // @JvmField val TLS_ECDH_RSA_WITH_CAMELLIA_256_GCM_SHA384 =
    // init("TLS_ECDH_RSA_WITH_CAMELLIA_256_GCM_SHA384", 0xc08d)
    // @JvmField val TLS_PSK_WITH_CAMELLIA_128_GCM_SHA256 =
    // init("TLS_PSK_WITH_CAMELLIA_128_GCM_SHA256", 0xc08e)
    // @JvmField val TLS_PSK_WITH_CAMELLIA_256_GCM_SHA384 =
    // init("TLS_PSK_WITH_CAMELLIA_256_GCM_SHA384", 0xc08f)
    // @JvmField val TLS_DHE_PSK_WITH_CAMELLIA_128_GCM_SHA256 =
    // init("TLS_DHE_PSK_WITH_CAMELLIA_128_GCM_SHA256", 0xc090)
    // @JvmField val TLS_DHE_PSK_WITH_CAMELLIA_256_GCM_SHA384 =
    // init("TLS_DHE_PSK_WITH_CAMELLIA_256_GCM_SHA384", 0xc091)
    // @JvmField val TLS_RSA_PSK_WITH_CAMELLIA_128_GCM_SHA256 =
    // init("TLS_RSA_PSK_WITH_CAMELLIA_128_GCM_SHA256", 0xc092)
    // @JvmField val TLS_RSA_PSK_WITH_CAMELLIA_256_GCM_SHA384 =
    // init("TLS_RSA_PSK_WITH_CAMELLIA_256_GCM_SHA384", 0xc093)
    // @JvmField val TLS_PSK_WITH_CAMELLIA_128_CBC_SHA256 =
    // init("TLS_PSK_WITH_CAMELLIA_128_CBC_SHA256", 0xc094)
    // @JvmField val TLS_PSK_WITH_CAMELLIA_256_CBC_SHA384 =
    // init("TLS_PSK_WITH_CAMELLIA_256_CBC_SHA384", 0xc095)
    // @JvmField val TLS_DHE_PSK_WITH_CAMELLIA_128_CBC_SHA256 =
    // init("TLS_DHE_PSK_WITH_CAMELLIA_128_CBC_SHA256", 0xc096)
    // @JvmField val TLS_DHE_PSK_WITH_CAMELLIA_256_CBC_SHA384 =
    // init("TLS_DHE_PSK_WITH_CAMELLIA_256_CBC_SHA384", 0xc097)
    // @JvmField val TLS_RSA_PSK_WITH_CAMELLIA_128_CBC_SHA256 =
    // init("TLS_RSA_PSK_WITH_CAMELLIA_128_CBC_SHA256", 0xc098)
    // @JvmField val TLS_RSA_PSK_WITH_CAMELLIA_256_CBC_SHA384 =
    // init("TLS_RSA_PSK_WITH_CAMELLIA_256_CBC_SHA384", 0xc099)
    // @JvmField val TLS_ECDHE_PSK_WITH_CAMELLIA_128_CBC_SHA256 =
    // init("TLS_ECDHE_PSK_WITH_CAMELLIA_128_CBC_SHA256", 0xc09a)
    // @JvmField val TLS_ECDHE_PSK_WITH_CAMELLIA_256_CBC_SHA384 =
    // init("TLS_ECDHE_PSK_WITH_CAMELLIA_256_CBC_SHA384", 0xc09b)
    ...
    // @JvmField val TLS_ECDHE_ECDSA_WITH_AES_128_CCM = init("TLS_ECDHE_ECDSA_WITH_AES_128_CCM",
    // 0xc0ac)
    // @JvmField val TLS_ECDHE_ECDSA_WITH_AES_256_CCM = init("TLS_ECDHE_ECDSA_WITH_AES_256_CCM",
    // 0xc0ad)
    // @JvmField val TLS_ECDHE_ECDSA_WITH_AES_128_CCM_8 = init("TLS_ECDHE_ECDSA_WITH_AES_128_CCM_8",
    // 0xc0ae)
    // @JvmField val TLS_ECDHE_ECDSA_WITH_AES_256_CCM_8 = init("TLS_ECDHE_ECDSA_WITH_AES_256_CCM_8",
    // 0xc0af)
    @JvmField
    val TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256 =
    ...
    @JvmField
    val TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256 =
        init("TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256", 0xccaa)

    // @JvmField val TLS_PSK_WITH_CHACHA20_POLY1305_SHA256 =
    // init("TLS_PSK_WITH_CHACHA20_POLY1305_SHA256", 0xccab)
    @JvmField
    val TLS_ECDHE_PSK_WITH_CHACHA20_POLY1305_SHA256 =
        init("TLS_ECDHE_PSK_WITH_CHACHA20_POLY1305_SHA256", 0xccac)
    // @JvmField val TLS_DHE_PSK_WITH_CHACHA20_POLY1305_SHA256 =
    // init("TLS_DHE_PSK_WITH_CHACHA20_POLY1305_SHA256", 0xccad)
    // @JvmField val TLS_RSA_PSK_WITH_CHACHA20_POLY1305_SHA256 =
     ...
     * @param value
     * ```
     * the integer identifier for this cipher suite. (Documentation only.)
     */
