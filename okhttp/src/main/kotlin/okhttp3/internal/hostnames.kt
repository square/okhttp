 ...
 * example this converts `☃.net` to `xn--n3h.net`, and `WwW.GoOgLe.cOm` to `www.google.com`. `null`
 * will be returned if the host cannot be ToASCII encoded or if the result contains unsupported
 * ASCII characters.
 */
