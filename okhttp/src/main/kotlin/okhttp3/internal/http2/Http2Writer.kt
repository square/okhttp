...
class Http2Writer(private val sink: BufferedSink, private val client: Boolean) : Closeable {
  ...
  @Synchronized
  @Throws(IOException::class)
  fun headers(outFinished: Boolean, streamId: Int, headerBlock: List<Header>) {
    if (closed) throw IOException("closed")
