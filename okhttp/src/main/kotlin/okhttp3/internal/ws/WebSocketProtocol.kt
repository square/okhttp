...
object WebSocketProtocol {
  ...
  */
   ...
   *
   * If this flag is set, the next four bytes represent the mask key. These bytes appear after any
   * additional bytes specified by [B1_MASK_LENGTH].
   */
   ...
   *
   * If this value is [PAYLOAD_SHORT], the next two bytes represent the length. If this value is
   * [PAYLOAD_LONG], the next eight bytes represent the length.
   */
