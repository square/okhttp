...
class AndroidPlatform : Platform() {
   ...
   *
   * This class exploits knowledge of Android implementation details. This class is potentially much
   * faster to initialize than [BasicTrustRootIndex] because it doesn't need to load and index
