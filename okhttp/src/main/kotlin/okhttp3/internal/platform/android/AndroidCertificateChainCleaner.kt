...
/**
 * Android implementation of CertificateChainCleaner using direct Android API calls. Not used if
 * X509TrustManager doesn't implement [X509TrustManager.checkServerTrusted] with an additional host
 * param.
 */
internal class AndroidCertificateChainCleaner(
  ...
  override fun equals(other: Any?): Boolean =
      other is AndroidCertificateChainCleaner && other.trustManager === this.trustManager
    ...
    fun buildIfSupported(trustManager: X509TrustManager): AndroidCertificateChainCleaner? {
      val extensions =
          try {
            ...
            // X509TrustManagerExtensions checks for checkServerTrusted(X509Certificate[], String,
            // String)
            null
          }
