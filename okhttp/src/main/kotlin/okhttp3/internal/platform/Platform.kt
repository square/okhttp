 ...
 * ### Session Tickets
 *
 * Supported on Android 2.3+. Supported on JDK 8+ via Conscrypt.
 *
 ...
 *
 * Supported on Android 2.3+ and OpenJDK 7+. There are no public APIs to recover the trust manager
 * that was used to create an [SSLSocketFactory].
 *
