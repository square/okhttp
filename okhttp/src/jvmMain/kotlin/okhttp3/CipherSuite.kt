...
class CipherSuite private constructor(
  ...
  companion object {
    ...
    // Last updated 2022-07-24 using cipher suites from Android 24 and Java 9.

    // @JvmField val TLS_NULL_WITH_NULL_NULL = init("TLS_NULL_WITH_NULL_NULL", 0x0000)
    @JvmField val TLS_RSA_WITH_NULL_MD5 = init("TLS_RSA_WITH_NULL_MD5", 0x0001)
    @JvmField val TLS_RSA_WITH_NULL_SHA = init("TLS_RSA_WITH_NULL_SHA", 0x0002)
    // @JvmField val TLS_RSA_EXPORT_WITH_RC4_40_MD5 = init("TLS_RSA_EXPORT_WITH_RC4_40_MD5", 0x0003)
    // @JvmField val TLS_RSA_WITH_RC4_128_MD5 = init("TLS_RSA_WITH_RC4_128_MD5", 0x0004)
    // @JvmField val TLS_RSA_WITH_RC4_128_SHA = init("TLS_RSA_WITH_RC4_128_SHA", 0x0005)
    // @JvmField val TLS_RSA_EXPORT_WITH_RC2_CBC_40_MD5 = init("TLS_RSA_EXPORT_WITH_RC2_CBC_40_MD5", 0x0006)
    // @JvmField val TLS_RSA_WITH_IDEA_CBC_SHA = init("TLS_RSA_WITH_IDEA_CBC_SHA", 0x0007)
    @JvmField val TLS_RSA_EXPORT_WITH_DES40_CBC_SHA = init("TLS_RSA_EXPORT_WITH_DES40_CBC_SHA", 0x0008)
    @JvmField val TLS_RSA_WITH_DES_CBC_SHA = init("TLS_RSA_WITH_DES_CBC_SHA", 0x0009)
    @JvmField val TLS_RSA_WITH_3DES_EDE_CBC_SHA = init("TLS_RSA_WITH_3DES_EDE_CBC_SHA", 0x000a)
    // @JvmField val TLS_DH_DSS_EXPORT_WITH_DES40_CBC_SHA = init("TLS_DH_DSS_EXPORT_WITH_DES40_CBC_SHA", 0x000b)
    ...
    // @JvmField val TLS_DH_RSA_EXPORT_WITH_DES40_CBC_SHA = init("TLS_DH_RSA_EXPORT_WITH_DES40_CBC_SHA", 0x000e)
    ...
    @JvmField val TLS_DHE_DSS_EXPORT_WITH_DES40_CBC_SHA = init("TLS_DHE_DSS_EXPORT_WITH_DES40_CBC_SHA", 0x0011)
    @JvmField val TLS_DHE_DSS_WITH_DES_CBC_SHA = init("TLS_DHE_DSS_WITH_DES_CBC_SHA", 0x0012)
    @JvmField val TLS_DHE_DSS_WITH_3DES_EDE_CBC_SHA = init("TLS_DHE_DSS_WITH_3DES_EDE_CBC_SHA", 0x0013)
    @JvmField val TLS_DHE_RSA_EXPORT_WITH_DES40_CBC_SHA = init("TLS_DHE_RSA_EXPORT_WITH_DES40_CBC_SHA", 0x0014)
    @JvmField val TLS_DHE_RSA_WITH_DES_CBC_SHA = init("TLS_DHE_RSA_WITH_DES_CBC_SHA", 0x0015)
    @JvmField val TLS_DHE_RSA_WITH_3DES_EDE_CBC_SHA = init("TLS_DHE_RSA_WITH_3DES_EDE_CBC_SHA", 0x0016)
    // @JvmField val TLS_DH_anon_EXPORT_WITH_RC4_40_MD5 = init("TLS_DH_anon_EXPORT_WITH_RC4_40_MD5", 0x0017)
    // @JvmField val TLS_DH_anon_WITH_RC4_128_MD5 = init("TLS_DH_anon_WITH_RC4_128_MD5", 0x0018)
    @JvmField val TLS_DH_anon_EXPORT_WITH_DES40_CBC_SHA = init("TLS_DH_anon_EXPORT_WITH_DES40_CBC_SHA", 0x0019)
    @JvmField val TLS_DH_anon_WITH_DES_CBC_SHA = init("TLS_DH_anon_WITH_DES_CBC_SHA", 0x001a)
    @JvmField val TLS_DH_anon_WITH_3DES_EDE_CBC_SHA = init("TLS_DH_anon_WITH_3DES_EDE_CBC_SHA", 0x001b)
    ...
    // @JvmField val TLS_SM4_GCM_SM3 = init("TLS_SM4_GCM_SM3", 0x00c6)
    // @JvmField val TLS_SM4_CCM_SM3 = init("TLS_SM4_CCM_SM3", 0x00c7)
    ...
    // @JvmField val TLS_ECCPWD_WITH_AES_128_GCM_SHA256 = init("TLS_ECCPWD_WITH_AES_128_GCM_SHA256", 0xc0b0)
    // @JvmField val TLS_ECCPWD_WITH_AES_256_GCM_SHA384 = init("TLS_ECCPWD_WITH_AES_256_GCM_SHA384", 0xc0b1)
    // @JvmField val TLS_ECCPWD_WITH_AES_128_CCM_SHA256 = init("TLS_ECCPWD_WITH_AES_128_CCM_SHA256", 0xc0b2)
    // @JvmField val TLS_ECCPWD_WITH_AES_256_CCM_SHA384 = init("TLS_ECCPWD_WITH_AES_256_CCM_SHA384", 0xc0b3)
    // @JvmField val TLS_SHA256_SHA256 = init("TLS_SHA256_SHA256", 0xc0b4)
    // @JvmField val TLS_SHA384_SHA384 = init("TLS_SHA384_SHA384", 0xc0b5)
    // @JvmField val TLS_GOSTR341112_256_WITH_KUZNYECHIK_CTR_OMAC = init("TLS_GOSTR341112_256_WITH_KUZNYECHIK_CTR_OMAC", 0xc100)
    // @JvmField val TLS_GOSTR341112_256_WITH_MAGMA_CTR_OMAC = init("TLS_GOSTR341112_256_WITH_MAGMA_CTR_OMAC", 0xc101)
    // @JvmField val TLS_GOSTR341112_256_WITH_28147_CNT_IMIT = init("TLS_GOSTR341112_256_WITH_28147_CNT_IMIT", 0xc102)
    // @JvmField val TLS_GOSTR341112_256_WITH_KUZNYECHIK_MGM_L = init("TLS_GOSTR341112_256_WITH_KUZNYECHIK_MGM_L", 0xc103)
    // @JvmField val TLS_GOSTR341112_256_WITH_MAGMA_MGM_L = init("TLS_GOSTR341112_256_WITH_MAGMA_MGM_L", 0xc104)
    // @JvmField val TLS_GOSTR341112_256_WITH_KUZNYECHIK_MGM_S = init("TLS_GOSTR341112_256_WITH_KUZNYECHIK_MGM_S", 0xc105)
    // @JvmField val TLS_GOSTR341112_256_WITH_MAGMA_MGM_S = init("TLS_GOSTR341112_256_WITH_MAGMA_MGM_S", 0xc106)
    ...
    // @JvmField val TLS_ECDHE_PSK_WITH_AES_128_GCM_SHA256 = init("TLS_ECDHE_PSK_WITH_AES_128_GCM_SHA256", 0xd001)
    // @JvmField val TLS_ECDHE_PSK_WITH_AES_256_GCM_SHA384 = init("TLS_ECDHE_PSK_WITH_AES_256_GCM_SHA384", 0xd002)
    // @JvmField val TLS_ECDHE_PSK_WITH_AES_128_CCM_8_SHA256 = init("TLS_ECDHE_PSK_WITH_AES_128_CCM_8_SHA256", 0xd003)
    // @JvmField val TLS_ECDHE_PSK_WITH_AES_128_CCM_SHA256 = init("TLS_ECDHE_PSK_WITH_AES_128_CCM_SHA256", 0xd005)
