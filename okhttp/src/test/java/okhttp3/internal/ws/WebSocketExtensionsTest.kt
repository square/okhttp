...
class WebSocketExtensionsTest {
  ...
  fun noExtensionHeader() {
    assertThat(WebSocketExtensions.parse(headersOf())).isEqualTo(WebSocketExtensions())
  }
  ...
  fun unknownExtension() {
    assertThat(parse("unknown-ext")).isEqualTo(WebSocketExtensions(unknownValues = true))
  }

  @Test
  fun perMessageDeflate() {
    assertThat(parse("permessage-deflate")).isEqualTo(WebSocketExtensions(perMessageDeflate = true))
  }
  ...
  fun repeatedPerMessageDeflate() {
    assertThat(parse("permessage-deflate, permessage-deflate; server_no_context_takeover"))
        .isEqualTo(
            WebSocketExtensions(
                perMessageDeflate = true, serverNoContextTakeover = true, unknownValues = true))
  }
  ...
  fun multiplePerMessageDeflateHeaders() {
    val extensions =
        WebSocketExtensions.parse(
            headersOf(
                "Sec-WebSocket-Extensions", "", "Sec-WebSocket-Extensions", "permessage-deflate"))
    assertThat(extensions).isEqualTo(WebSocketExtensions(perMessageDeflate = true))
  }
  ...
  fun noContextTakeoverClient() {
    assertThat(parse("permessage-deflate; client_no_context_takeover"))
        .isEqualTo(WebSocketExtensions(perMessageDeflate = true, clientNoContextTakeover = true))
  }

  @Test
  fun noContextTakeoverServer() {
    assertThat(parse("permessage-deflate; server_no_context_takeover"))
        .isEqualTo(WebSocketExtensions(perMessageDeflate = true, serverNoContextTakeover = true))
  }

  @Test
  fun clientMaxWindowBits() {
    assertThat(parse("permessage-deflate; client_max_window_bits=8"))
        .isEqualTo(WebSocketExtensions(perMessageDeflate = true, clientMaxWindowBits = 8))
    assertThat(parse("permessage-deflate; client_max_window_bits=\"8\""))
        .isEqualTo(WebSocketExtensions(perMessageDeflate = true, clientMaxWindowBits = 8))
    assertThat(parse("permessage-deflate; client_max_window_bits=15"))
        .isEqualTo(WebSocketExtensions(perMessageDeflate = true, clientMaxWindowBits = 15))
    assertThat(parse("permessage-deflate; client_max_window_bits=\"15\""))
        .isEqualTo(WebSocketExtensions(perMessageDeflate = true, clientMaxWindowBits = 15))
    assertThat(parse("permessage-deflate; client_max_window_bits\t =\t 8\t "))
        .isEqualTo(WebSocketExtensions(perMessageDeflate = true, clientMaxWindowBits = 8))
  ...
  fun serverMaxWindowBits() {
    assertThat(parse("permessage-deflate; server_max_window_bits=8"))
        .isEqualTo(WebSocketExtensions(perMessageDeflate = true, serverMaxWindowBits = 8))
    assertThat(parse("permessage-deflate; server_max_window_bits=\"8\""))
        .isEqualTo(WebSocketExtensions(perMessageDeflate = true, serverMaxWindowBits = 8))
    assertThat(parse("permessage-deflate; server_max_window_bits=15"))
        .isEqualTo(WebSocketExtensions(perMessageDeflate = true, serverMaxWindowBits = 15))
    assertThat(parse("permessage-deflate; server_max_window_bits=\"15\""))
        .isEqualTo(WebSocketExtensions(perMessageDeflate = true, serverMaxWindowBits = 15))
    assertThat(parse("permessage-deflate; server_max_window_bits\t =\t 8\t "))
        .isEqualTo(WebSocketExtensions(perMessageDeflate = true, serverMaxWindowBits = 8))
  ...
  fun unexpectedValue() {
    assertThat(parse("permessage-deflate; client_no_context_takeover=true"))
        .isEqualTo(
            WebSocketExtensions(
                perMessageDeflate = true, clientNoContextTakeover = true, unknownValues = true))
  ...
  @Test
  fun absentValue() {
    assertThat(parse("permessage-deflate; server_max_window_bits"))
        .isEqualTo(WebSocketExtensions(perMessageDeflate = true, unknownValues = true))
  }
