...
object Dependencies {
  ...
  const val spotlessPlugin = "com.diffplug.spotless:spotless-plugin-gradle:6.0.0"
  ...
  const val equinox = "org.eclipse.platform:org.eclipse.osgi:3.17.0"
  const val guava = "com.google.guava:guava:31.0.1-jre"
  const val hamcrest = "org.hamcrest:hamcrest-library:2.2"
  const val jnrUnixsocket = "com.github.jnr:jnr-unixsocket:0.38.13"
