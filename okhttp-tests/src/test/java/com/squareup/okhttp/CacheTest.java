...
public final class CacheTest {
  ...
  @Test public void defaultExpirationDateConditionallyCached() throws Exception {
    ...
    assertEquals(lastModifiedDate, conditionalRequest.getHeaders().get("If-Modified-Since"));
  }
  ...
  @Test public void etag() throws Exception {
    RecordedRequest conditionalRequest = assertConditionallyCached(new MockResponse()
        .addHeader("ETag: v1"));
    assertEquals("v1", conditionalRequest.getHeaders().get("If-None-Match"));
  }
  ...
  @Test public void clientSuppliedIfModifiedSinceWithCachedResult() throws Exception {
    MockResponse response = new MockResponse()
        .addHeader("ETag: v3").addHeader("Cache-Control: max-age=0");
    String ifModifiedSinceDate = formatDate(-24, TimeUnit.HOURS);
    RecordedRequest request =
        assertClientSuppliedCondition(response, "If-Modified-Since", ifModifiedSinceDate);
    assertEquals(ifModifiedSinceDate, request.getHeaders().get("If-Modified-Since"));
    assertEquals("v3", request.getHeaders().get("If-None-Match"));
  }
  ...
  @Test public void clientSuppliedIfNoneMatchSinceWithCachedResult() throws Exception {
    ...
    assertEquals("v1", request.getHeaders().get("If-None-Match"));
    assertEquals(lastModifiedDate, request.getHeaders().get("If-Modified-Since"));
  }
