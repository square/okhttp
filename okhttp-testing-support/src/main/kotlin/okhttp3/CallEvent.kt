...
sealed class CallEvent {
  ...
  data class SecureConnectStart(override val timestampNs: Long, override val call: Call) :
      CallEvent()
  ...
  data class CallStart(override val timestampNs: Long, override val call: Call) : CallEvent()

  data class CallEnd(override val timestampNs: Long, override val call: Call) : CallEvent() {
  ...
  data class Canceled(override val timestampNs: Long, override val call: Call) : CallEvent()

  data class RequestHeadersStart(override val timestampNs: Long, override val call: Call) :
      CallEvent()
  ...
  data class RequestBodyStart(override val timestampNs: Long, override val call: Call) :
      CallEvent()
  ...
  data class ResponseHeadersStart(override val timestampNs: Long, override val call: Call) :
      CallEvent()
  ...
  data class ResponseBodyStart(override val timestampNs: Long, override val call: Call) :
      CallEvent()
  ...
  data class SatisfactionFailure(override val timestampNs: Long, override val call: Call) :
      CallEvent()

  data class CacheHit(override val timestampNs: Long, override val call: Call) : CallEvent()

  data class CacheMiss(override val timestampNs: Long, override val call: Call) : CallEvent()

  data class CacheConditionalHit(override val timestampNs: Long, override val call: Call) :
      CallEvent()
}
