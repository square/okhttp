...
public final class RealWebSocketCall extends WebSocketCall {

  private final Call call;
  private final Random random;
  private final String key;

  public RealWebSocketCall(OkHttpClient client, Request request) {
    this(client, request, new SecureRandom());
  }

  public RealWebSocketCall(OkHttpClient client, Request request, Random random) {
  ...
  void createWebSocket(Response response, WebSocketListener listener) throws IOException {
