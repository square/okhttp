...
import okhttp3.WireSharkListenerFactory.WireSharkKeyLoggerListener.Launch
...
class WireSharkListenerFactory(
  ...
  fun launchWireShark(): Process? {
    when (launch) {
      ...
      Launch.Gui -> {
        return ProcessBuilder(
            "nohup", "/Applications/Wireshark.app/Contents/MacOS/Wireshark", "-o", "tls.keylog_file:$logFile", "-S", "-l", "-Y", "http2", "-k")
            .redirectInput(File("/dev/null"))
