...
The latest release is available on [Maven Central](https://search.maven.org/artifact/com.squareup.okhttp3/okhttp/5.0.0-alpha.1/jar).
...
The latest release is available on [Maven Central](https://search.maven.org/artifact/com.squareup.okhttp3/mockwebserver/5.0.0-alpha.1/jar).

```kotlin
testImplementation("com.squareup.okhttp3:mockwebserver:5.0.0-alpha.1")
```
